...
<html lang="en">
    <head>
        ...
        <title>Fatema Kassem Portfolio </title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-12">
                            <div class="hero-text">
                                ...
                                <h2 class="mb-4">I’m Backend developer.</h2>
                                <p class="mb-4"><a class="custom-btn btn custom-link" href="#section_2">Download cv</a></p>
                            </div>
                        </div>

                        <div class="col-lg-5 col-12 position-relative">

                            <img src="images/fatema.png" class="hero-image img-fluid" alt="">
                            ...
                            <div class="profile-thumb">
                                ...
                                <div class="profile-body">
                                    <p>
                                        ...
                                        <span>Fatema Kassem</span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Birthday</span>
                                        <span>Aug 13, 1997</span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Phone</span>
                                         <span><a href="tel: 963937852005">963937852005</a></span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Email</span>
                                        <span><a href="mailto:fatemakassem183@gmail.com">fatemakassem183@gmail.com</a></span>
                                    </p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="services-thumb">
                                        <div class="d-flex flex-wrap align-items-center border-bottom mb-4 pb-3">
                                            ...
                                            <div class="services-price-wrap ms-auto">
                                                <p class="services-price-text mb-0">400$</p>
                                                <div class="services-price-overlay"></div>
                                            </div>
                                        </div>

                                        <p>If you need a customized  website for your business, feel free to discuss with me.</p>
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="services-thumb">
                                        <div class="d-flex flex-wrap align-items-center border-bottom mb-4 pb-3">
                                            ...
                                            <div class="services-price-wrap ms-auto">
                                                <p class="services-price-text mb-0">300$</p>
                                                <div class="services-price-overlay"></div>
                                            </div>
                                        </div>

                                        <p>To list your website first on any search engine, we will work together.</p>
...
<li class="social-icon-item"><a href="#" class="social-icon-link bi-telegram"></a></li>
                            ...
                            <div class="col-lg-3 col-md-6 col-12 ps-lg-0">
                                <div class="contact-info d-flex flex-column">
                                    ...
                                    <p class="mb-2">
                                        Fatema is a web developer. Feel free to get in touch with me.
                              </p>

                                    <strong class="site-footer-title d-block mt-4 mb-3">Email</strong>

                                    <p>
                                        <a href="fatemakassem183@gmail.com">
                                          fatemakassem183@gmail.com
                                        </a>
                                    </p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="copyright-text-wrap">
                            <p class="mb-0">
                                <span class="copyright-text">Copyright © 2024 <a href="#">Fatema Kassem</a></span>
                                </p>
                        </div>
                    </div>
